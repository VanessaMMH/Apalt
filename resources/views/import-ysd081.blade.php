...
@endif
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Importar YSD081') }}</h1>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-1">
                            <div class="text-center">
                                <h5 class="font-weight-bold">Importar columnas resaltadas del archivo YSD081</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form action="{{ route('import-ysd081') }}" method="POST" enctype="multipart/form-data">
                                @csrf
